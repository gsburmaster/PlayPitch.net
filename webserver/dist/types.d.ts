...
export type ClientMessage = AuthMessage | GameActionMessage | GameStartMessage | RoomLeaveMessage | PlayAgainMessage | PingMessage;
...
export type ServerMessage = AuthOkMessage | LobbyUpdateMessage | GameStartBroadcast | GameTurnMessage | GameBidMessage | GameTrumpChosenMessage | GameHandUpdateMessage | GameCardPlayedMessage | GameNoValidPlayMessage | GameTrickResultMessage | GameRoundEndMessage | GameNewRoundMessage | GameOverMessage | LobbyReturnMessage | PlayerStatusMessage | ErrorMessage | PongMessage;
